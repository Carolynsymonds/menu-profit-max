...
import { CheckCircle, ArrowRight, ArrowLeft, DollarSign, Users, Calendar, TrendingUp, Trash2, Megaphone, Loader2, Utensils, Coffee, Sandwich, Cake, Truck, UtensilsCrossed, Store } from "lucide-react";
          ...
          {businessTypes.map(type => {
            const getBusinessIcon = (businessType: string) => {
              switch (businessType) {
                ...
                case "Fast Food": return Sandwich;
